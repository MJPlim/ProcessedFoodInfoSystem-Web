...
const FoodDetail = ({ match }) => {
    const url =
        "/B553748/CertImgListService/getCertImgListService?ServiceKey=fTEm%2FiVcJFgwgjEeDhMET1kFQZduiSF09BedQaKgQRGH7fWSoKITTfTFZH2EzYono62%2BwMlAxdy2Jj64qzpgqQ%3D%3D&returnType=json&numOfRows=1&pageNo=1&prdlstReportNo=";
    ...
    const onMoveToLink = () => {
        var link =
            `https://search.shopping.naver.com/search/all?query=` + food[0].prdlstNm;
            ...
            <Container>
                ...
                <Row>
                        ...
                        <Row className="bottomBorderLine">
                            ...
                            <Col lg="8">
                                <Table>
                                    <tr>
                                        <th>상품명</th>
                                        <td>{food[0].prdlstNm}</td>
                                    </tr>
                                    <tr>
                                        <th>제조사</th>
                                        <td>{food[0].manufacture}</td>
                                    </tr>
                                    <tr>
                                        <th>바코드</th>
                                        <td>{food[0].barcode}</td>
                                    </tr>
                                </Table>
                            </Col>
                        </Row>
                    ...
                    <Col md="6">
                        ...
                        <FormGroup>
                            <Label for="reviewFrom" className="reviewLabel">
                                사용자 후기 작성하기
                            </Label>
